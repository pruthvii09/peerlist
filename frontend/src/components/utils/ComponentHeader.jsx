...
const ComponentHeader = ({ title, iconConfig, href, follow }) => {
      ...
      <div className="flex items-center">
        {Icon &&
          (href ? (
            ...
            <div className="px-2 cursor-pointer py-2 border border-gray-300 rounded-full flex items-center gap-1 h-[36px]">
              <Icon size={size} />
              {iconText && <span className="text-xs">{iconText}</span>}
            </div>
          ))}
